...
path <- "~/gadget/models/simulations/advr/results"
...
mod_levels <- paste0("age_prop_", c(0, 0.01, 0.1, 0.2, 0.5, 0.75, 1))
mod_labels <- paste("Age Prop", c(0, 0.01, 0.1, 0.2, 0.5, 0.75, 1))
...
comm_alpha_plot <- 
  param_re_plot("comm_alpha", expression(italic(alpha["fleet"])))
