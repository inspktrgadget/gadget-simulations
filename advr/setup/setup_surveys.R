...
cod_survey_selectivity <-
    logistic_selectivity(cod_lengrps, cod_survey_alpha, cod_survey_l50, max_prop = 1e-05)
flatfish_survey_selectivity <-
    logistic_selectivity(flatfish_lengrps, flatfish_survey_alpha, flatfish_survey_l50, max_prop = 1e-05)
capelin_survey_selectivity <-
    logistic_selectivity(capelin_lengrps, capelin_survey_alpha, capelin_survey_l50, max_prop = 1e-05)
survey_error <- 0.2
catch_error <- 0.2
