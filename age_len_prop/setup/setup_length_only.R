# sample Gadget OMs without any age data (i.e. length only)
library(methods)
library(gadgetSim)
library(tidyverse)
...
om_dir <- "~/gadget/simulations/op_mods/var_rec"
          ...
          browser()
            ...
            spr_comp_data <-
                ...
                strip_age_length_data(length_samples = 200,
                                      age_samples = 1, # set to 1 but not used
                                      quiet = TRUE)
            aut_comp_data <-
                aut_survey_samples %>%
                strip_age_length_data(length_samples = 200,
...
#-----------------------------------------
# create a directory for models with no age data
