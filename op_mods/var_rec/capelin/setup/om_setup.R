...
om_dir <- "~/gadget/models/simulations/op_mods/var_rec/capelin"
...
twt_mod <- simulate_model(capelin_twt_stock, twt_fleet, "two_way_trip")
fd_mod <- simulate_model(capelin_fd_stock, fish_down_fleet, "fish_down")
fmsy_mod <- simulate_model(capelin_fmsy_stock, flat_msy_fleet, "flat_msy")
