...
base_om_dir <- "~/gadget/models/simulations/op_mods/flatfish"
...
flatfish_twt_stock <- make_scenario_stock("two_way_trip")
flatfish_fd_stock <- make_scenario_stock("fish_down")
flatfish_fmsy_stock <- make_scenario_stock("flat_msy")
