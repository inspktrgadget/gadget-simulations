...
path <- "~/gadget/models/simulations/age_data_var_rec/results"
...
mod_levels <- 
  c(paste0("age_prop_", c(0.01, 0.1, 0.2, 0.5, 1)),
    paste0("age_samples_", c(50,100,200,500,1000)))
mod_labels <- 
  c(paste("Age Prop", c(0.01, 0.1, 0.2, 0.5, 1)),
    paste("Age Samples", c(50,100,200,500,1000)))
